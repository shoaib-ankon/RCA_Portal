...
session_start();
    if(isset($_POST['Login']))
    {
       ...
       {
            $query1="select * from table1 where username='".$_POST['username']."' and password='".$_POST['password']."'";// rclogin table name
            ...
            if(mysqli_fetch_assoc($result))
            {
                ...
                $query2="select * from table2 where username='".$_POST['username']."' and password='".$_POST['password']."'";// rclogin table name
