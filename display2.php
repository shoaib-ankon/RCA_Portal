...
<body>
 ...
 <h1 class="text-warning text-center" > RO RCA Feedback </h1>
...
<form method="post" action="export.php">
 ...
 <td> <button class="btn-primary btn"> <a href="update2.php?serial=<?php echo $res['serial']; ?>" class="text-white"> Feedback </a> </button> </td>
